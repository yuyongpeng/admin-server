...
export class ResourceController {
  ...
  @RequirePermission("fangcunjiyi:resource:query")
  @Get("/list")
  ...
  @RequirePermission("fangcunjiyi:resource:export")
  @Get("/export")
  ...
  @RequirePermission("fangcunjiyi:resource:add")
  @Post("/")
  ...
  @RequirePermission("fangcunjiyi:resource:edit")
  @Put("/")
  ...
  @ApiResponse({ type: Result<any> })
  @RequirePermission("fangcunjiyi:resource:remove")
  @Delete("/:ids")
